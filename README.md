...
**Morse-decoder** Converts the morse code symbols into letters
...
```sh
  cd my-folder
  git clone https://github.com/haliljon/morse-decoder.git
...
Feel free to check the [issues page](https://github.com/haliljon/hospital-db/issues).
